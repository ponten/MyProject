...
namespace SajetClass
{
    class SajetCommon
    {
        ...
        public static string g_sCallerName = string.Empty;
        ...
        {
            //轉換元件Txt的多國語言
            ClientUtils.SetLanguage(c, g_sExeName, g_sFileName);
            ClientUtils.SetLanguage(c, g_sExeName, g_sCallerName);
