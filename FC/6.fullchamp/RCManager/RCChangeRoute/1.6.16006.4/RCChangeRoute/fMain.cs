...
namespace RC_ChangeRoute
{
    public partial class fMain : Form
    {
        ...
        public void ShowData()
        {
            ...
            {
                // 2016.11.24 By Jason
                sSQL = " SELECT RC_NO,CURRENT_STATUS "
                ...
                if (dsTemp.Tables[0].Rows.Count == 0)
                {
                    string sMsg = SajetCommon.SetLanguage("RC number not release");
                    SajetCommon.Show_Message(sMsg, 1);
                    return;
                }
                // 2016.11.24 End
                ...
                // 2016.4.21 By Jason
                sSQL = " SELECT A.RC_NO,A.CURRENT_STATUS"
                ...
                if (dsTemp.Tables[0].Rows.Count == 0)
                {
                    string sMsg = SajetCommon.SetLanguage("Work Order Status must be WIP");
                    SajetCommon.Show_Message(sMsg, 1);
                    return;
                }
                else
...
//                        }
                        ...
                        oParams[11] = new object[] { ParameterDirection.Input, OracleType.VarChar, "RELEASE", "Y" };
