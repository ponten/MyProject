        ...
        private void Excute_button_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Dgv_RC.Rows.Count; i++)
            {
                ...
                if (IsChecked)
                {
                    ...
                    #region 因為轉投料號的輸入框被藏起來了，改檢查邏輯

                    if (sCurrent_Status == "11" && string.IsNullOrWhiteSpace(TB_OPTION1.Text))
                    {
                        TB_OPTION1.Text = "N/A";
                    }
                    ...
                    #region 因為工單單別的輸入框被藏起來了，改檢查邏輯

                    if(sCurrent_Status == "11" && string.IsNullOrWhiteSpace(TB_OPTION2.Text))
                    {
                        TB_OPTION2.Text = "N/A";
                    }
            ...
            string message = SajetCommon.SetLanguage("Exception list completed");
