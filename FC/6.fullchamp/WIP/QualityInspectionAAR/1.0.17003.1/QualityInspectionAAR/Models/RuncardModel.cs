namespace QualityInspectionAAR.Models
{
    ...
    public class RuncardModel
    {
        ...
        public RuncardModel(RuncardModel e)
        {
            ...
            IN_PROCESS_TIME = e.IN_PROCESS_TIME;

            OUT_PROCESS_TIME = e.OUT_PROCESS_TIME;
        }
        ...
        /// 投入時間
        /// </summary>
        public string IN_PROCESS_TIME { get; set; } = string.Empty;

        /// <summary>
        /// 產出時間
        /// </summary>
        public string OUT_PROCESS_TIME { get; set; } = string.Empty;
    }
}
