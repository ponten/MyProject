...
";
            ...
            Params = new List<object[]>
            {
                ...
                new object[] { ParameterDirection.Input, OracleType.Number, "TGOOD", programInfo.txtGood.Text },
                new object[] { ParameterDirection.Input, OracleType.Number, "TSCRAP", programInfo.txtScrap.Text },
                new object[] { ParameterDirection.Input, OracleType.Number, "TNEXTPROCESS", rcRoute.sNext_Process },
                new object[] { ParameterDirection.Input, OracleType.Number, "TNEXTNODE", rcRoute.sNext_Node },
                new object[] { ParameterDirection.Input, OracleType.VarChar, "TNEXTSHEET", rcRoute.sSheet_Name },
                new object[] { ParameterDirection.Input, OracleType.Number, "TBONUS", TbBonus.Text },
