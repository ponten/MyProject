...
namespace RCOutput.Services
{
    ...
    internal static class QCOptionService
    {
        ...
        /// <returns></returns>
        internal static QCOptionEnum GetInspectType(string rc_no)
        {
...
";
        ...
        /// <param name="rc_no"></param>
        /// <returns></returns>
        internal static bool HasInspectOne(string rc_no)
        {
            string s = @"
SELECT
    A.RC_NO,
...
";
            ...
            return d != null
                ...
                && int.TryParse(d.Tables[0].Rows[0]["INSPECT_QTY"].ToString(), out int inspect_qty)
                && inspect_qty > 0;
        }
    }
}
