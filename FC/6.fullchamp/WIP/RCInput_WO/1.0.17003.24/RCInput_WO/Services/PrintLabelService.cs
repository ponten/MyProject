...
";
                p.Add(new object[] { ParameterDirection.Input, OracleType.Number, "PROCESS_ID", 100019 });
...
WHERE
    ...
    AND A.PROCESS_ID = :PROCESS_ID
";
                p.Add(new object[] { ParameterDirection.Input, OracleType.Number, "PROCESS_ID", 100020 });
...
WHERE
    ...
    AND A.PROCESS_ID = :PROCESS_ID
";
                p.Add(new object[] { ParameterDirection.Input, OracleType.Number, "PROCESS_ID", 100024 });
