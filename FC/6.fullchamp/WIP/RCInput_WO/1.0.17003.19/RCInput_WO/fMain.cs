...
";
        ...
        private void DtpInDate_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (!ShareSettings)
            {
                RC_Details.First(x => x.RC_NO == Current_RC_NO).IN_PROCESS_TIME = DtpInDate.Value;

                RC_Details.First(x => x.RC_NO == Current_RC_NO).DateTimePicker_set = true;
            }
        ...
        private void CbReportTime_CheckStateChanged(object sender, EventArgs e)
        {
            ...
            {
                RC_Details.First(x => x.RC_NO == Current_RC_NO).IN_PROCESS_TIME = IN_PROCESS_TIME;

                RC_Details.First(x => x.RC_NO == Current_RC_NO).DateTimePicker_set = false;
        ...
        private void BtnOK_Click(object sender, EventArgs e)
        {
            ...
            foreach (var rc in ExecuteRCs)
            {
                foreach (var row in rc.Machines.Where(x => x.Select))
                {
                    ...
                    // 爐序號
                    //string stoveSeq = row.STOVE_SEQ?.ToString().Trim() ?? "";
