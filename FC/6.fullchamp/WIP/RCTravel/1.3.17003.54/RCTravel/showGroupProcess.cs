            ...
            if (dsGrid != null && dsGrid.Tables[0].Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    for (int ii = 0; ii < dsGrid.Tables[0].Rows.Count; ii++)
                    {
                        ...
                        Params[1] = new object[] { ParameterDirection.Input, OracleType.Number, "PROCESS_ID", dsGrid.Tables[0].Rows[ii][1].ToString() };
                        ...
                        Params[4] = new object[] { ParameterDirection.Input, OracleType.Number, "GROUP_ID", gGroup };
                        Params[5] = new object[] { ParameterDirection.Input, OracleType.Number, "SEQ", ii };
