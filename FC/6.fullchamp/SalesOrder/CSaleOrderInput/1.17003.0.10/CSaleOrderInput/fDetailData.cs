...
";
                ...
                if (!isValid)
                {
                    var msg = SajetCommon.SetLanguage("Not all input data is valid. Please check again.", 1);
                ...
                switch (UpdateTypeEnum)
                {
                    case UpdateType.Append:
                        AppendData();
                        var sMsg = SajetCommon.SetLanguage("Data Append OK", 2) + " !" + Environment.NewLine +
        ...
        {
            if (!ValidNumericalTextBox(tbQuantity))
            {
                return false;
            }
            if (!ValidNumericalTextBox(tbWeight))
            {
                return false;
            }
            if (!ValidNumericalTextBox(tbUnitPrice))
            {
                return false;
            }
            if (!ValidNumericalTextBox(tbAmount))
            {
                return false;
            }
            return true;
        ...
        private bool ValidNumericalTextBox(TextBox textBox)
        {
            ...
            {
                var msgQuote = SajetCommon.SetLanguage("Must be a number", 1);
        ...
        private bool IsDataFilled()
        {
            ...
            {
                var msg = SajetCommon.SetLanguage("'Number' cannot be empty!", 1);
                MessageBox.Show(msg, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
            ...
            {
                var msg = SajetCommon.SetLanguage("'Serial Number' cannot be empty!", 1);
                MessageBox.Show(msg, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }

            if (string.IsNullOrEmpty(tbProduceNumber.Text.Trim()))
            {
                var msg = SajetCommon.SetLanguage("'Produce Number' cannot be empty!", 1);
                MessageBox.Show(msg, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                tbProduceNumber.Focus();
                return false;
            }
            ...
            {
                var msg = SajetCommon.SetLanguage("'Quantity' cannot be empty!", 1);
                MessageBox.Show(msg, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                tbQuantity.Focus();
                return false;
            }
            ...
            if (string.IsNullOrEmpty(tbAmount.Text.Trim()))
            {
                ...
                // 預設 0
                //var msg = SajetCommon.SetLanguage("'Amount' cannot be empty!", 1);
                //MessageBox.Show(msg, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                //return false;
            }
            ...
            if (string.IsNullOrEmpty(dtPickerRealDate.Text.Trim()))
            {
                var msg = SajetCommon.SetLanguage("'Creation Date' cannot be empty!", 1);
                MessageBox.Show(msg, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                dtPickerRealDate.Focus();
                return false;
            }

            if (string.IsNullOrEmpty(dtPickerRealDueDate.Text.Trim()))
            {
                var msg = SajetCommon.SetLanguage("'Due Date' cannot be empty!", 1);
                MessageBox.Show(msg, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
...
";
        ...
        private void SetUnitWeightByResult(string unitWeight)
        {
            if (string.IsNullOrEmpty(unitWeight))
            {
                ...
                tbUnitWeight.Text = "<" + SajetCommon.SetLanguage("Empty", 1) + ">";
            }
            else if (!double.TryParse(unitWeight, out double result))
            {
                lblUnitWeight.ForeColor = Color.Red;
                lblUnitWeightWarning.Visible = true;
                tbUnitWeight.Text = "<" + SajetCommon.SetLanguage("Not a number", 1) + ">";
            }
            else
            {
        ...
        private void btnCalculateWeight_Click(object sender, EventArgs e)
        {
            ...
            {
                var msg = SajetCommon.SetLanguage("'Unit Weight' and 'Quantity' must be numbers", 1);
                MessageBox.Show(msg, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void btnCalculateAmount_Click(object sender, EventArgs e)
        {
            ...
            {
                var msg = SajetCommon.SetLanguage("'Unit Price' and 'Quantity' must be numbers", 1);
                MessageBox.Show(msg, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
