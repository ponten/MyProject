...
namespace CSaleOrderInput
{
    public partial class fData : Form
    {
        ...
        Func<string, object> Lang = s => SajetCommon.SetLanguage(Convert.ToString(s));
...
";
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                string Body = $"資料異動{Environment.NewLine}{Lang("Number1")}: {tbNumber1.Text}{Environment.NewLine}{Lang("Number2")}: {tbNumber2.Text} ";
